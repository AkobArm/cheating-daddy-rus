...
const DEFAULT_PREFERENCES = {
    ...
    selectedDisplayId: '',
    // Держать окно поверх остальных. Иначе оно уходит за окно созвона при первом же клике мимо.
    keepWindowOnTop: true,
    // Запрос, который уходит вместе с ручным скриншотом. Прежний текст был написан под
    // квизы на веб-страницах («page», «mcq») и сбивал модель на техническом интервью.
    manualScreenshotPrompt: '',

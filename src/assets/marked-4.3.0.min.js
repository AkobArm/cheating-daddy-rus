...
!(function (e, t) {
            ...
            (n = (function (e, t) {
                ...
                if (e)
                    return 'string' == typeof e
                        ? s(e, t)
                        : 'Map' ===
                                (u = 'Object' === (u = Object.prototype.toString.call(e).slice(8, -1)) && e.constructor ? e.constructor.name : u) ||
                            'Set' === u
                          ? Array.from(e)
    ...
    function f(e, t, u) {
        ...
        t &&
            ...
            (t = -1 === (n = g[' ' + n]).indexOf(':')),
            (u = '//' === e.substring(0, 2) ? (t ? e : n.replace(j, '$1') + e) : '/' === e.charAt(0) ? (t ? e : n.replace(P, '$1') + e) : n + e));
        try {
    ...
    function m(e, t, u, n) {
        var r = t.href,
            ...
            i = e[1].replace(/\\([\[\]])/g, '$1');
        return '!' !== e[0].charAt(0)
            ? ((n.state.inLink = !0), (e = { type: 'link', raw: u, href: r, title: t, text: i, tokens: n.inlineTokens(i) }), (n.state.inLink = !1), e)
            ...
            return (
                ...
                (t.code = function (e) {
                    ...
                    if (e)
                        return (
                            ...
                            { type: 'code', raw: e[0], codeBlockStyle: 'indented', text: this.options.pedantic ? t : C(t, '\n') }
                        );
                }),
                (t.fences = function (e) {
                    var t,
                ...
                (t.heading = function (e) {
                    ...
                    if (e)
                        return (
                            (t = e[2].trim()),
                            /#$/.test(t) && ((u = C(t, '#')), (!this.options.pedantic && u && !/ $/.test(u)) || (t = u.trim())),
                        ...
                        for (
                            ...
                            if (
                                ...
                                this.options.pedantic
                                    ? ((i = 2), (c = o.trimLeft()))
                                    : ((i = t[2].search(/[^ ]/)), (c = o.slice((i = 4 < i ? 1 : i))), (i += t[1].length)),
                                (s = !1),
                                ...
                                if (D)
                                    if (((a = D.length), n[3] || n[4])) s += a;
                                        ...
                                        return (
                                            ...
                                            Math.min(i, a) % 2
                                                ? ((a = D.slice(1, -1)), { type: 'em', raw: D, text: a, tokens: this.lexer.inlineTokens(a) })
                                                : ((a = D.slice(2, -2)), { type: 'strong', raw: D, text: a, tokens: this.lexer.inlineTokens(a) })
                                        );
                            }
                        }
                    }
                ...
                (t.autolink = function (e, t) {
                    ...
                    if (e)
                        return (
                            (t = '@' === e[2] ? 'mailto:' + (u = A(this.options.mangle ? t(e[1]) : e[1])) : (u = A(e[1]))),
    ...
    var v = (function () {
            function u(e) {
                ...
                (this.options.pedantic
                    ...
                    : this.options.gfm && ((e.block = B.gfm), this.options.breaks ? (e.inline = w.breaks) : (e.inline = w.gfm)),
            ...
            return (
                ...
                (n.inlineTokens = function (r, t) {
                    ...
                    for (; null != (n = this.tokenizer.rules.inline.blockSkip.exec(a));)
                        a = a.slice(0, n.index) + '[' + E('a', n[0].length - 2) + ']' + a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                    for (; null != (n = this.tokenizer.rules.inline.escapedEmSt.exec(a));)
                        ((a = a.slice(0, n.index + n[0].length - 2) + '++' + a.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex)),
            ...
            return (
                (t.code = function (e, t, u) {
                    ...
                    return (
                        ...
                        (e = e.replace(/\n$/, '') + '\n'),
                        t
                            ? '<pre><code class="' + this.options.langPrefix + A(t) + '">' + (u ? e : A(e, !0)) + '</code></pre>\n'
                        ...
                        if (
                            ...
                            this.options.extensions &&
                                ...
                                (!1 !== (A = this.options.extensions.renderers[a.type].call({ parser: this }, a)) ||
                                    !['space', 'hr', 'heading', 'code', 'table', 'blockquote', 'list', 'html', 'paragraph', 'text'].includes(a.type)))
                        )
                            k += A || '';
                        else
                            switch (a.type) {
                                ...
                                case 'table':
                                    ...
                                    for (D += this.renderer.tablerow(l), o = '', r = a.rows.length, u = 0; u < r; u++) {
                                        for (l = '', i = (s = a.rows[u]).length, n = 0; n < i; n++)
                                            l += this.renderer.tablecell(this.parseInline(s[n].tokens), { header: !1, align: a.align[n] });
                                ...
                                case 'paragraph':
                                    ...
                                    continue;
                                case 'text':
                                    for (o = a.tokens ? this.parseInline(a.tokens) : a.text; C + 1 < d && 'text' === e[C + 1].type;)
    ...
    ((T.passThroughHooks = new Set(['preprocess', 'postprocess'])),
        ...
        (I.use = function () {
            for (var D = I.defaults.extensions || { renderers: {}, childTokens: {} }, e = arguments.length, t = new Array(e), u = 0; u < e; u++)
                t[u] = arguments[u];
                                ...
                                (D[r.level] ? D[r.level].unshift(r.tokenizer) : (D[r.level] = [r.tokenizer]),
                                    r.start &&
                                        ('block' === r.level
                                            ...
                                            : 'inline' === r.level && (D.startInline ? D.startInline.push(r.start) : (D.startInline = [r.start]))));
                            }

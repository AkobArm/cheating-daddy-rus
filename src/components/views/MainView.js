...
export class MainView extends LitElement {
    ...
    _renderChatGptMode() {
        return html`
            <div class="form-group">
                <div class="form-hint">Uses your ChatGPT Plus/Pro subscription through your signed-in OpenAI account — no API key required.</div>
            </div>

            <div class="form-group">
                <div class="form-hint">
                    Connect your ChatGPT account in Settings before starting a session. The Connect button lives there under "ChatGPT subscription
                    (OpenAI)".
                </div>
            </div>
    ...
    render() {
        ...
        return html`
            <div class="form-wrapper">
                ${
                    this._mode === 'local'
                        ? html`
                          ...
                          `
                        : this._mode === 'chatgpt'
                          ? html` <div class="page-title">${html`Cheating Daddy <span class="mode-suffix">ChatGPT</span>`}</div> `
                ...
                ${this._mode === 'byok' ? this._renderByokMode() : ''} ${this._mode === 'chatgpt' ? this._renderChatGptMode() : ''}
